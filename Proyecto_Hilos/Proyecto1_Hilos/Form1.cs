...
namespace Proyecto1_Hilos
{
    public partial class Form1 : Form
    {
        ...
        private Semaphore semaforo = new Semaphore(5,5); // Limitar a 5 hilos concurrentes
        public Form1()
        {
            InitializeComponent();
        }
        ...
        private void IdentificarNumeros()
        {
            for (int i = 1; i <= 20; i++)
            {
                semaforo.WaitOne(); // Esperar si el número de hilos concurrentes es mayor o igual a 5
                ...
                Thread T = new Thread(() =>
                {
                    ...
                    finally
                    {
                        ...
                        Interlocked.Decrement(ref contadorHilos); // Decrementar el contador de hilos de manera segura
                        MostrarContadorHilos(); // Mostrar el contador de hilos
                    }
                });
                T.Start();

                Interlocked.Increment(ref contadorHilos); // Incrementar el contador de hilos de manera segura
                MostrarContadorHilos(); // Mostrar el contador de hilos
        ...
        private void MostrarContadorHilos()
        {
            Invoke(new Action(() => TXT_Prueba.Text = contadorHilos.ToString()));
        }
